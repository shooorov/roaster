            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="flex flex-col sm:flex-row sm:justify-between items-center px-4 py-5 border-b border-gray-200 sm:px-8">
                        <p class="max-w-2xl leading-10 text-gray-700 text-lg font-medium mb-4 sm:mb-0">User Create</p>
                        ...
                        <dl class="space-y-4 sm:space-y-6 px-5 py-6">
                            ...
                            <div class="max-w-5xl mx-auto space-y-4 sm:space-y-6">
                                ...
                                <div class="grid sm:grid-cols-3 sm:gap-2">
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1">
                                        <input v-model="form.email" placeholder="Email" type="email" autocomplete="email" class="block w-full px-4 focus:ring-indigo-400 focus:border-indigo-400 hover:bg-gray-100 focus:bg-transparent sm:text-sm border-gray-300 rounded">
                                    </dd>
                                </div>

                                <div class="grid sm:grid-cols-3 sm:gap-2">
                                    <dt class="text-sm sm:leading-10 font-semibold text-gray-700 tracking-wider sm:text-right pr-8"> Password <span class="text-red-500">*</span> </dt>
                                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1">
                                        <div class="flex rounded shadow-sm">
                                            <input class="focus-within:z-10 focus:ring-indigo-400 focus:border-indigo-400 hover:bg-gray-100 focus:bg-transparent block w-full px-4 sm:text-sm border-gray-300 rounded-l" :type="password_invisible ? 'password' : 'text'" placeholder="Password" v-model="form.password" label="Password" autocomplete="new-password">
								...
								<div v-if="form.type == 'other'" class="grid sm:grid-cols-3 sm:gap-2">
