<template>
    <Head title="Edit Central Kitchen" />
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="flex flex-col sm:flex-row sm:justify-between items-center px-4 py-5 border-b border-gray-200 sm:px-8">
                        <p class="max-w-2xl leading-10 text-gray-700 text-lg font-medium mb-4 sm:mb-0">Central Kitchen Edit</p>
                            ...
                            <div class="max-w-xl mx-auto">
                                <div class="grid grid-cols-4 gap-4">
                                    ...
                                    <div class="col-span-4 sm:col-span-2">
                                        ...
                                        <input v-model="form.short_code" placeholder="Short Code" type="text" class="mt-1 block w-full px-4 focus:ring-indigo-400 focus:border-indigo-400 hover:bg-gray-100 focus:bg-transparent sm:text-sm border-gray-300 rounded">
                                        <InputError :message="$page.props.errors.short_code" />
                                    </div>

                                    <div class="col-span-4 sm:col-span-2">
                                        <label class="block text-sm font-medium text-gray-700"> Contact Number </label>
                                        <input v-model="form.contact" placeholder="Contact Number" type="text" class="mt-1 block w-full px-4 focus:ring-indigo-400 focus:border-indigo-400 hover:bg-gray-100 focus:bg-transparent sm:text-sm border-gray-300 rounded">
                                        <InputError :message="$page.props.errors.contact" />
                                    </div>

                                    <div class="col-span-4 sm:col-span-4">
                                        <label class="block text-sm font-medium text-gray-700"> Address </label>
                                        <textarea v-model="form.address" placeholder="Address" rows="3" class="mt-1 block w-full px-4 focus:ring-indigo-400 focus:border-indigo-400 hover:bg-gray-100 focus:bg-transparent sm:text-sm border-gray-300 rounded"></textarea>
...
export default {
    ...
    setup (props) {
        ...
        const form = reactive({
            name: props.central_kitchen.name,
            short_code: props.central_kitchen.short_code,
            contact: props.central_kitchen.phone,
            address: props.central_kitchen.address,
        })

        function submit() {
            router.post(route('central.update', props.central_kitchen.id), form)
        }
