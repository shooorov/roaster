<template>
    <Head title="Create Central Kitchen" />
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="flex flex-col sm:flex-row sm:justify-between items-center px-4 py-5 border-b border-gray-200 sm:px-8">
                        <p class="max-w-2xl leading-10 text-gray-700 text-lg font-medium mb-4 sm:mb-0">Central Kitchen Create</p>
...
export default {
    ...
    setup (props) {
        ...
        function submit() {
            router.post(route('central.store'), form);
        }
