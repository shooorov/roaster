                        ...
                        <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ml-4 mt-4">
                                <div class="flex items-center">
                                    <div class="ml-2">
                                        <h3 class="text-lg leading-6 font-medium text-gray-900"> {{ account.name }} ({{ account.type }}) </h3>
                                        <p class="mt-1 max-w-2xl text-sm text-gray-500"> Account details and information. </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="border-t border-gray-200">
                        <dl>
                            <div class="bg-white md:px-8 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"> {{ account.balance }} </dd>
                            </div>
                            <div class="bg-primary-50 md:px-8 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500"> Number </dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"> {{ account.number }} </dd>
                            </div>
                            <div class="bg-white md:px-8 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500"> Branch </dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"> {{ account.branch }} </dd>
                            </div>
                            <div class="bg-primary-50 md:px-8 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500"> Opening Balance </dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"> {{ account.opening_balance }} </dd>
                            </div>
                            <div class="bg-white md:px-8 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500"> Opening Date </dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"> {{ account.opening_date }} </dd>
                            </div>
                            <div class="bg-primary-50 md:px-8 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <div class="bg-white md:px-8 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"> {{ account.remark }} </dd>
                            </div>
                        </dl>
                    </div>
                </div>
