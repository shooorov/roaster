            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="flex flex-col sm:flex-row sm:justify-between items-center px-4 py-5 border-b border-gray-200 sm:px-8">
                        <p class="max-w-2xl leading-10 text-gray-700 text-lg font-medium mb-4 sm:mb-0">Method Edit</p>
                        ...
                        <dl class="space-y-4 sm:space-y-6 px-5 py-6">
                            ...
                            <div class="grid sm:grid-cols-3 sm:gap-2 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1">
                                    <p class="sm:leading-10 tracking-wider px-4" :style="displayStyle">
										{{ form.name }}
									</p>
                            ...
                            <div class="grid sm:grid-cols-3 sm:gap-2 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1">
                                    <input v-model="form.bg_color" type="text" placeholder="#ffffff" class="focus:ring-indigo-400 focus:border-indigo-400 hover:bg-gray-100 focus:bg-transparent block w-full px-4 sm:text-sm border-gray-300 rounded">
                                    <InputError :message="$page.props.errors.bg_color" />
                                </dd>
                            </div>
                            ...
                            <div class="grid sm:grid-cols-3 sm:gap-2 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1">
                                    <input v-model="form.text_color" type="text" placeholder="#6b7280" class="focus:ring-indigo-400 focus:border-indigo-400 hover:bg-gray-100 focus:bg-transparent block w-full px-4 sm:text-sm border-gray-300 rounded">
                                    <InputError :message="$page.props.errors.text_color" />
                                </dd>
                            </div>

                            <div class="grid sm:grid-cols-3 sm:gap-2 sm:px-6">
                                <dt class="text-sm sm:leading-10 font-semibold text-gray-700 tracking-wider sm:text-right pr-8">
                                    <label>Text Size Code</label>
                                </dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1">
                                    <input v-model="form.text_size" type="text" placeholder="14px" class="focus:ring-indigo-400 focus:border-indigo-400 hover:bg-gray-100 focus:bg-transparent block w-full px-4 sm:text-sm border-gray-300 rounded">
                                    <InputError :message="$page.props.errors.text_size" />
                                </dd>
                            </div>

                            <div class="grid sm:grid-cols-3 sm:gap-2 sm:px-6">
                                <dt class="text-sm sm:leading-10 font-semibold text-gray-700 tracking-wider sm:text-right pr-8">
                                    <label>Font Weight Code</label>
                                </dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1">
                                    <input v-model="form.font_weight" type="text" placeholder="400" class="focus:ring-indigo-400 focus:border-indigo-400 hover:bg-gray-100 focus:bg-transparent block w-full px-4 sm:text-sm border-gray-300 rounded">
                                    <InputError :message="$page.props.errors.font_weight" />
                                </dd>
                            </div>
...
export default {
	...
	computed: {
        displayStyle() {
            return reactive({
				...
				fontSize: this.form.text_size,
				fontWeight: this.form.font_weight,
			});
        },
	},
    ...
    setup (props) {
        ...
        const form = reactive({
            ...
            bg_color: props.method.bg_color,
            text_color: props.method.text_color,
            text_size: props.method.text_size,
            font_weight: props.method.font_weight,
        })

        function submit() {
            router.patch(route('method.update', props.method.id), form)
        }
