<template>
    <Head title="Edit Other Sale Category" />
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="flex flex-col sm:flex-row sm:justify-between items-center px-4 py-5 border-b border-gray-200 sm:px-8">
                        <p class="max-w-2xl leading-10 text-gray-700 text-lg font-medium mb-4 sm:mb-0"> Other Sale Category Edit</p>
                        ...
                        <dl class="space-y-4 sm:space-y-6 px-5 py-6">
                            ...
                            <!-- <div class="grid sm:grid-cols-3 sm:gap-2 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-gray-700 sm:mt-0 sm:col-span-1">
                                    <Combobox class="mt-1" v-model="form.other_sale_category_id" :items="other_categories" />
                                </dd>
                            </div> -->
...
export default {
    ...
    setup (props) {
        ...
        const form = reactive({
            name: props.other_sale_category.name,
            type: props.other_sale_category.type,
            other_sale_category_id: props.other_sale_category.other_sale_category_id,
        })

        function submit() {
            router.patch(route('other_sale_category.update', props.other_sale_category.id), form)
        }
