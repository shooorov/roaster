                ...
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
                        <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ml-4 mt-4">
                                <p class="max-w-2xl leading-10 text-gray-700 text-lg font-medium mb-4 sm:mb-0">Profile</p>
                            </div>
                    ...
                    <form @submit.prevent="submit">
                        <dl class="space-y-8 px-5 py-6">
                            ...
                            <div class="max-w-5xl mx-auto space-y-4 sm:space-y-6">
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1">
                                        <div class="relative h-32 w-32">
                                            <div class="flex text-sm text-gray-700 border border-gray-400 rounded-md bg-gray-50">
                                                <img class="object-cover h-32 w-32" :src="form.image?? form.image_default" title="Click to upload image">
                                            ...
                                            <div v-show="form.image != form.image_default" class="absolute top-0 right-0 px-0 py-0 bg-gray-50 opacity-60" title="Remove Image">
                                                <XMarkIcon class="w-5 h-5 text-red-500 hover:text-red-700 cursor-pointer" aria-hidden="true" @click="form.image = form.image_default; $refs.image.value = ''; form.image_removed = true" />
                                            </div>
                                            <div v-show="form.image != profile.image" class="absolute top-0 left-0 px-0 py-0 bg-gray-50 opacity-60" title="Refresh Image">
                                                <ArrowPathIcon class="w-5 h-5 text-primary-500 hover:text-primary-700 cursor-pointer" aria-hidden="true" @click="form.image = profile.image; $refs.image.value = ''; form.image_removed = false" />
                                            </div>
                                        </div>
                                ...
                                <div class="grid sm:grid-cols-3 sm:gap-2">
                                    <dt class="text-sm sm:leading-10 font-semibold text-gray-700 tracking-wider sm:text-right pr-8"> Email </dt>
                                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1">
                                ...
                                <div class="grid sm:grid-cols-3 sm:gap-2">
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                        <textarea v-model="form.address" placeholder="Address Here" rows="4" type="text" class="block w-full px-4 focus:ring-indigo-400 focus:border-indigo-400 hover:bg-gray-100 focus:bg-transparent sm:text-sm border-gray-300 rounded"></textarea>
...
export default {
    ...
    setup (props) {
        ...
        const form = reactive({
            ...
            image: props.profile.image_url,
            image_default: props.profile.image_default,
            image_removed: false,
        })
