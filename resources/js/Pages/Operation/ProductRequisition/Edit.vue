                ...
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="flex flex-col sm:flex-row sm:justify-between items-center px-4 py-5 border-b border-gray-200 sm:px-8">
                        ...
                        <div class="flex-shrink-0 flex space-x-3">
                            ...
                            <ModelOptions :detailHref="route('product_requisition.show', requisition.id)" :editHref="null" :deleteHref="route('product_requisition.destroy', requisition.id)" deleteMessage="Do you really want to delete this requisition?" />
                        </div>
                    </div>
...
export default {
    ...
    setup(props) {
        ...
        const form = reactive({
            ...
            total_format: props.requisition.group_items.reduce((carry, val) => carry + Number(val.total), 0).toLocaleString('en-US'),
