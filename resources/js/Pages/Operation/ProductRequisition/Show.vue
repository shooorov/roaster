                    ...
                    <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
                        <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            ...
                            <div class="ml-4 mt-4 shrink-0 flex">
                                ...
                                <ModelOptions :detailHref="null" :editHref="route('product_requisition.edit', requisition.id)" :deleteHref="route('product_requisition.destroy', requisition.id)" deleteMessage="Do you really want to delete this requisition?" />
                            </div>
                        </div>
                    </div>
