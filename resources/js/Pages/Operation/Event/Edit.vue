                ...
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="flex flex-col sm:flex-row sm:justify-between items-center px-4 py-5 border-b border-gray-200 sm:px-8" >
                        ...
                        <div class="flex-shrink-0 flex space-x-3">
                            <ModelOptions :detailHref="route('event.show', event.id)" :editHref="null" :deleteHref="route('event.destroy', event.id)" deleteMessage="Do you really want to delete this event?" />
                        </div>
                    </div>
...
export default {
    ...
    setup(props) {
        ...
        function submit() {
            router.patch(route("event.update", props.event.id), form);
        }
