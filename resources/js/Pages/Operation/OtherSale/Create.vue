                        ...
                        <dl class="space-y-4 sm:space-y-6 px-5 py-6">
                            <div class="max-w-5xl mx-auto space-y-4 sm:space-y-6">
                                <div class="md:px-0 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    <dt class="text-sm leading-10 font-semibold text-gray-700 tracking-wider text-right pr-8" > Date Time <span class="text-red-500">*</span> </dt>
...
export default {
    ...
    setup(props) {
        ...
        const form = reactive({
            ...
            branch_id: null,
            account_id: null,
            other_sale_category_id: null,
            description: null,
        });

        function submit() {
            router.post(route("other_sale.store"), form);
        }
