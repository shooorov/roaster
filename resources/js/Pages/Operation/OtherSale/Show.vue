                    ...
                    <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
                        <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                                ...
                                <div class="flex items-center">
                                    <div class="ml-4">
                                        <h3 class="text-lg leading-6 font-medium text-gray-900">
                                            {{ other_sale.category_name }} ({{ other_sale.type }})
                                        </h3>
                                        <p class="mt-1 max-w-2xl text-sm text-gray-500">
                                            Other Sale details and information.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 shrink-0 flex">
                                <ModelOptions :detailHref="null" :editHref="route('other_sale.edit', other_sale.id)" :deleteHref="route('other_sale.destroy', other_sale.id)" deleteMessage="Do you really want to delete this other_sale?" />
                            </div>
                        </div>
                    </div>
