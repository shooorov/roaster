                ...
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="flex flex-col sm:flex-row sm:justify-between items-center px-4 py-5 border-b border-gray-200 sm:px-8" >
                        ...
                        <div class="flex-shrink-0 flex space-x-3">
                            <!-- <ModelOptions :detailHref="route('expense.show', expense.id)" :editHref="null" :deleteHref="route('expense.destroy', expense.id)" deleteMessage="Do you really want to delete this expense?" /> -->
                        </div>
                    </div>
...
export default {
    ...
    setup(props) {
        ...
        const form = reactive({
            ...
            check_no: props.expense.check_no,
        ...
        function submit() {
            router.patch(route("expense.update", props.expense.id), form);
        }
