                ...
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="flex flex-col sm:flex-row sm:justify-between items-center px-4 py-5 border-b border-gray-200 sm:px-8">
                        ...
                        <div class="flex-shrink-0 flex space-x-3">
                            ...
                            <ModelOptions :detailHref="route('kitchen_delivery.show', kitchen_delivery.id)" :editHref="null" :deleteHref="route('kitchen_delivery.destroy', kitchen_delivery.id)" deleteMessage="Do you really want to delete this kitchen_delivery?" />
                        </div>
                    </div>
                        ...
                        <dl class="space-y-4 sm:space-y-6 px-5 py-6">
                            ...
                            <div class="max-w-xl mx-auto">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <label class="block text-sm font-medium text-gray-700"> Delivery Branch <span class="text-red-500">*</span> </label>
...
export default {
    ...
    setup(props) {
        ...
        const form = reactive({
            ...
            group_items: props.kitchen_delivery.group_items.map(item => {
				// item.quantity = '';
				item.show = true;
				return item;
			}),
