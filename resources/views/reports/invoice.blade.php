        ...
        <table class="border-collapse w-full mb-5">
            <tbody>
                @if ($order->delivery_cost)
                    <tr>
                        <td class="align-middle text-xl font-bold text-left py-1" colspan="4">Delivery Cost</td>
                        <td class="align-middle text-xl font-bold text-right py-1">{{ $order->delivery_cost }}</td>
                    </tr>
                @endif
                <tr>
                    <td class="align-middle text-xl font-bold text-left py-1" colspan="4">Sub Total</td>
                    <td class="align-middle text-xl font-bold text-right py-1">{{ $order->sub_total }}</td>
                </tr>
                <tr>
                    <td class="align-middle text-xl font-bold text-left py-1" colspan="4">VAT</td>
                    <td class="align-middle text-xl font-bold text-right py-1">{{ $order->vat_amount }}</td>
                </tr>
                <tr>
                    <td class="align-middle text-xl font-bold text-left py-1" colspan="4">Discount</td>
                    <td class="align-middle text-xl font-bold text-right py-1">{{ $order->discount_amount }}</td>
                </tr>
                <tr>
                    <td class="align-middle text-2xl font-bold text-left py-1" colspan="4">Total:</td>
                    <td class="align-middle text-xl font-bold text-right py-1">{{ $order->total }}</td>
                </tr>
                @if ($order->cash)
                    <tr>
                        <td class="align-middle text-xl font-bold text-left py-1" colspan="4">Cash</td>
                        <td class="align-middle text-xl font-bold text-right py-1">{{ $order->cash }}</td>
                    </tr>
                @endif
                @if ($order->change)
                    <tr>
                        <td class="align-middle text-xl font-bold text-left py-1" colspan="4">Change</td>
                        <td class="align-middle text-xl font-bold text-right py-1">{{ $order->change }}</td>
                    </tr>
                @endif
            </tbody>
        </table>

        <h1 class="mb-4 w-full text-xl font-bold text-center"> Thank You </h1>
    </div>
@endsection
