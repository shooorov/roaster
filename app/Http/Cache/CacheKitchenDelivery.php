...
use App\Models\KitchenDelivery as ModelsKitchenDelivery;
use App\UseBranch;
use Illuminate\Support\Facades\Cache;

class CacheKitchenDelivery
{
    private static $key = 'KitchenDelivery';
    ...
    public static function get()
    {
        ...
        return Cache::remember($cache_key, now()->addHours(2), function () {
            return ModelsKitchenDelivery::orderBy('date', 'DESC')->get();
        });
    }
